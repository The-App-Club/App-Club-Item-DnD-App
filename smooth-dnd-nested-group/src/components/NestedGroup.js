...
class NestedGroup extends Component {
  constructor() {
    super();
                              ...
                              return (
                                <Draggable key={j}>
                                  ...
                                  >
                                    ...
                                    <div style={{ cursor: 'default' }}>
                                      <Container getChildPayload={(index) => this.state.items[i].items[j].items[index]} groupName="1" onDrop={(e) => this.containerOnDrop3(i, j, e)}>
                                        {q.items.map((t, y) => {
                                          return (
                                            <Draggable key={y}>
                                              <div
